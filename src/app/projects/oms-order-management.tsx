...
export default function OmsOrderManagementCaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-8 transition-colors duration-500 selection:bg-[#00229E]/20">
      {/* Global Page Tint Accent */}
      <div className="fixed inset-0 z-[-1] pointer-events-none opacity-[0.15]" style={{ backgroundColor: "#00229E" }} />
      ...
      <div className="relative overflow-hidden pt-32 pb-8 border-b border-border/10">
        ...
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-[#00229E]/10 via-transparent to-transparent blur-[120px] pointer-events-none" />
        <div className="absolute -bottom-20 left-1/4 w-[400px] h-[400px] rounded-full bg-gradient-to-tr from-[#00229E]/5 to-transparent blur-[100px] pointer-events-none" />
          ...
          <div className="mt-12 pt-8 border-t border-border/20 space-y-8">
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <span className="text-foreground/90 font-medium block pt-0.5 leading-relaxed">Web Dashboard & Mobile Scanner</span>
              </div>
              <div className="space-y-1.5">
                <span className="text-muted-foreground uppercase text-[10px] tracking-widest block font-bold">Tech Stack</span>
                <span className="text-foreground/90 font-medium block pt-0.5 leading-relaxed">React, Next.js, tailwind CSS, GraphQL, Postgres</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl mt-16">
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-4">
            <span className="text-[#00229E] text-xs font-semibold tracking-widest uppercase block">Impact</span>
          ...
          >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#00229E]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                <div className="relative z-10 space-y-4">
                  <div className="text-4xl font-black font-space-grotesk bg-gradient-to-r from-[#00229E] to-foreground bg-clip-text text-transparent">
                    40%
                  </div>
                  <div>
                    <h4 className="text-base font-bold font-space-grotesk tracking-wide text-foreground mb-1">
                      Faster Stock Dispatch
                    </h4>
                    <p className="text-xs text-muted-foreground leading-relaxed text-justify font-inter">
                      Consolidated incoming orders into a unified warehouse queue.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed text-justify font-inter">
                      Integrated live barcode scanning sheets, avoiding manual typing mistakes.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed text-justify font-inter">
                      Fulfillment logs updated retail storefronts with zero data delay.
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-3">
            <span className="text-[#00229E] text-xs font-semibold tracking-widest uppercase block">Operational Model / The Challenge</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight leading-tight">
              The Friction of Fragmented Retail Fulfillment
            </h3>
          ...
          <motion.div variants={fadeInUp} className="space-y-6 w-full pt-2">
            <div className="space-y-6 text-base md:text-[20px] leading-relaxed text-muted-foreground/80 font-inter">
                ...
                <div key={1} className="space-y-1 pt-4 first:pt-0 border-t first:border-t-0 border-border/10">
                  <h4 className="font-bold text-foreground font-space-grotesk uppercase tracking-wider text-xs flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-500/80 animate-pulse" />
                    02 / Manual Stock Re-orders
                  </h4>
                  <p className="text-sm pl-3.5 text-justify font-inter">Restocking items required manual review of spreadsheets, causing stockouts.</p>
                </div>
                ...
                <div key={2} className="space-y-1 pt-4 first:pt-0 border-t first:border-t-0 border-border/10">
                  <h4 className="font-bold text-foreground font-space-grotesk uppercase tracking-wider text-xs flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-500/80 animate-pulse" />
                    03 / Fragmented Carrier Chats
                  </h4>
                  <p className="text-sm pl-3.5 text-justify font-inter">Coordinating logistics partners required staff to exit the app and call carriers.</p>
                </div>
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-3 w-full">
            <span className="text-[#00229E] text-xs font-semibold tracking-widest uppercase block">Operational Model / Reality</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight md:whitespace-nowrap">
              Two Roles, One Cohesive Warehouse
            </h3>
            ...
            <div className="bg-[#0B0B0C]/80 backdrop-blur-md border border-border/40 p-1.5 rounded-2xl sm:rounded-full flex flex-col sm:flex-row items-stretch sm:items-center justify-center max-w-md w-full shadow-2xl gap-1">
              <Button
                ...
                className={"flex-1 rounded-xl sm:rounded-full py-3.5 sm:py-5.5 cursor-pointer font-space-grotesk transition-all duration-300 " + (
                  selectedRole === "buyer" 
                    ? "bg-[#00229E] text-black font-semibold shadow-[0_4px_15px_rgba(0,230,115,0.25)] hover:bg-[#00229E]" 
                    : "text-muted-foreground hover:text-foreground hover:bg-foreground/5"
                )}
              >
                <Smartphone className="w-4 h-4 mr-2 flex-shrink-0" />
                <span className="truncate">Warehouse Operator</span>
              </Button>
              <Button
                ...
                className={"flex-1 rounded-xl sm:rounded-full py-3.5 sm:py-5.5 cursor-pointer font-space-grotesk transition-all duration-300 " + (
                  selectedRole === "seller" 
                    ? "bg-[#00229E] text-black font-semibold shadow-[0_4px_15px_rgba(31,208,180,0.25)] hover:bg-[#00229E]" 
                    : "text-muted-foreground hover:text-foreground hover:bg-foreground/5"
                )}
              >
                <Bot className="w-4 h-4 mr-2 flex-shrink-0" />
                <span className="truncate">Floor Picker</span>
              </Button>
            </div>
          </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center font-inter">
                <div className="md:col-span-7 space-y-6">
                  <div className="flex items-center gap-3">
                    <span className="p-3.5 rounded-full bg-[#00229E]/10 text-[#00229E]">
                  ...
                  <p className="text-sm text-muted-foreground/90 leading-relaxed font-inter text-justify font-light">
                    The Operator schedules regional shipments and monitors bulk product demands. The design optimizes for fast searchability:
                  </p>
                  <ul className="space-y-3.5">
                      ...
                      <li key={0} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        ...
                        <span>Aggregates store orders into a single, ranked fulfillment pipeline.</span>
                      </li>
                      ...
                      <li key={2} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#00229E] flex-shrink-0 mt-0.5" />
                        <span>Enables fast cargo dispatcher assignments through styled control sheets.</span>
                      </li>
                ...
                <div className="md:col-span-5 p-4 bg-[#0B0B0C] border border-border/30 rounded-2xl flex flex-col gap-4 font-mono text-[11px] text-muted-foreground shadow-2xl relative overflow-hidden">
                  <div className="absolute top-2 right-2 px-2 py-0.5 rounded bg-[#00229E]/10 border border-[#00229E]/30 text-[#00229E] text-[9px] uppercase tracking-widest font-mono">
                    Overview Screen
                  </div>
                  <div className="border-b border-border/30 pb-3">
                    <div className="font-bold text-foreground text-xs font-space-grotesk uppercase tracking-wider mb-1">{"🖥️ Fulfillment Operations Panel"}</div>
                    <div className="text-[10px]">{"Filter: Active Shipments • Noida Depot • High Priority"}</div>
                  </div>
                  
                      <div key={0} className="p-3 rounded-lg bg-card/60 border border-border/40 flex justify-between items-center">
                        <div>
                          <div className="font-bold text-foreground">📦 Order #4312 - Wholesale</div>
                          <div className="text-[10px]">Fulfill: Critical • Delhi Area</div>
                        </div>
                        <div className="text-right font-mono">
                          <div className="font-bold text-[#00229E] text-xs">Stock: 4,000 units • active</div>
                          <div>Action: Dispatch Courier</div>
                        </div>
                      </div>
                      ...
                      <div key={1} className="p-3 rounded-lg bg-card/60 border border-border/40 flex justify-between items-center">
                        <div>
                          <div className="font-bold text-foreground">📦 Order #4311 - Bulk Retail</div>
                          <div className="text-[10px]">Fulfill: Normal • Gurugram Area</div>
                        </div>
                        <div className="text-right font-mono">
                          <div className="font-bold text-[#00229E] text-xs">Stock: 1,200 units • active</div>
                          <div>Action: None Required</div>
                        </div>
                      </div>
  
                  <div className="p-2.5 rounded-lg bg-[#00229E]/10 border border-[#00229E]/20 flex items-center justify-between text-foreground">
                    <span>Double Confirmation</span>
                    <span className="font-bold text-xs uppercase tracking-wider">{"Commit Bulk Shipment Release"}</span>
                  </div>
                </div>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center font-inter">
                <div className="md:col-span-7 space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xl font-bold font-space-grotesk tracking-wide text-foreground">
                                                Floor Picker (Guided Stock Picking)
                      </h4>
                      <p className="text-xs text-[#00229E] font-mono tracking-wider uppercase">Archetype: "Action-Oriented"</p>
                    </div>
                  </div>
                  <p className="text-sm text-muted-foreground/90 leading-relaxed font-inter text-justify font-light">
                    The Picker traverses warehouse aisles locating items. The mobile tablet experience provides clear navigation and offline inventory validation:
                  </p>
                  <ul className="space-y-3.5">
                    
                      <li key={0} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#00229E] flex-shrink-0 mt-0.5" />
                        <span>Provides structured checklist templates detailing aisle layout coordinates.</span>
                      </li>
  

                      <li key={1} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#00229E] flex-shrink-0 mt-0.5" />
                        <span>Integrates barcode camera scanners directly on active picking screens.</span>
                      </li>
  

                      <li key={2} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#00229E] flex-shrink-0 mt-0.5" />
                        <span>Enables offline logging to queue stock checks in thick steel depots.</span>
                      </li>
                ...
                <div className="md:col-span-5 p-4 bg-[#0B0B0C] border border-border/30 rounded-2xl flex flex-col gap-4 font-mono text-[11px] text-muted-foreground shadow-2xl relative overflow-hidden">
                  ...
                  <div className="border-b border-border/30 pb-3">
                    <div className="font-bold text-foreground text-xs font-space-grotesk uppercase tracking-wider mb-1">{"📋 Mobile Floor Picker App"}</div>
                    <div className="text-[10px]">{"Session Status: Offline Sync Active"}</div>
                  </div>
                  
                      <div key={0} className="p-2.5 rounded-lg bg-card/60 border border-border/30 text-[10px]">
                        <span className="font-bold text-foreground block mb-0.5">Item #204 - Copper Pipes</span>
                        Aisle: B2 • Shelf: 4 • Depot North • Action: Scan Item Barcode
                      </div>
  

                      <div key={1} className="p-2.5 rounded-lg bg-card/60 border border-border/30 text-[10px]">
                        <span className="font-bold text-foreground block mb-0.5">Item #203 - Steel Valves</span>
                        Aisle: C1 • Shelf: 2 • Depot South • Action: Complete Inspection
                      </div>
  
                  <div className="flex gap-2">
                    <span className="px-2.5 py-1.5 rounded-full border border-border/30 bg-card text-[9px] cursor-pointer">{"Commit Picking Checklist (↑)"}</span>
                  </div>
                </div>
              </div>
            )}
        ...
        >
          <motion.div variants={fadeInUp} className="w-full space-y-4">
            <span className="text-[#00229E] text-xs font-semibold tracking-widest uppercase block">Key Solution</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight">
              Core Design Moves
            </h3>
            <p className="text-[20px] text-muted-foreground/80 leading-relaxed text-justify font-inter">
          ...
          <motion.div variants={fadeInUp} className="p-8 rounded-[2rem] bg-card/30 border border-border/30 backdrop-blur-md space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/20 pb-6">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-full bg-[#00229E]/10 text-[#00229E] flex items-center justify-center font-bold font-space-grotesk text-lg border border-[#00229E]/20">01</div>
                <div>
                  <h4 className="text-[22px] font-semibold font-space-grotesk tracking-wide text-foreground">
                    Unified Fulfillment Feed
                  </h4>
                  <p className="text-xs text-muted-foreground font-mono">undefined</p>
                </div>
              </div>
              <ShieldCheck className="w-6 h-6 text-[#00229E]" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 leading-relaxed items-center">
              <div className="lg:col-span-7 space-y-5 font-inter text-[18px] text-muted-foreground/90">
                <p className="text-justify font-inter">
                  We consolidated storefront orders, ledger logs, and invoice states into a single, scannable warehouse feed with clear status tags.
                </p>
              </div>
              ...
              <div className="lg:col-span-5 flex items-center justify-center w-full">
                  ...
                  <div className="h-28 border border-border/20 rounded-lg bg-card/30 p-2 flex items-end relative overflow-hidden">
                    <div dangerouslySetInnerHTML={{ __html: "<svg className=\"w-full h-[70%] stroke-[#4f46e5] fill-none stroke-[2]\" viewBox=\"0 0 100 30\">\n                    <path d=\"M 0 25 Q 20 5, 40 20 T 80 5 T 100 15\" />\n                    <circle cx=\"40\" cy=\"20\" r=\"3\" className=\"fill-[#4f46e5] stroke-white stroke-[1]\" />\n                  </svg>" }} className="w-full" />
                  </div>
          ...
          <motion.div variants={fadeInUp} className="p-8 rounded-[2rem] bg-card/30 border border-border/30 backdrop-blur-md space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 leading-relaxed items-center font-inter">
              ...
              <div className="lg:col-span-7 space-y-5 font-inter text-base md:text-[18px] text-muted-foreground/90 order-1 lg:order-2">
                <p className="text-justify font-inter">
                  Designed interactive sliders that let operators balance minimum product volumes, avoiding expensive manual warehouse inventory checks.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="p-8 rounded-[2rem] bg-card/30 border border-border/30 backdrop-blur-md space-y-8 font-inter">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/20 pb-6">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-full bg-[#00229E]/10 text-[#00229E] flex items-center justify-center font-bold font-space-grotesk text-lg border border-[#00229E]/20">03</div>
                <div>
                  <h4 className="text-[22px] font-semibold font-space-grotesk tracking-wide text-foreground">
                    Conversational Logistics AI
                  </h4>
                  <p className="text-xs text-muted-foreground font-mono">undefined</p>
                </div>
              </div>
              <Bot className="w-6 h-6 text-[#00229E]" />
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 leading-relaxed items-center">
              <div className="lg:col-span-7 space-y-5 font-inter text-[18px] text-muted-foreground/90">
                <p className="text-justify font-inter">
                  Integrated an intelligent chat helper inside the picker app. Senders can ask 'Where is shipment 104?' and receive real-time GPS details.
                </p>
              </div>
              ...
              <div className="lg:col-span-5 p-5 bg-[#0B0B0C] border border-border/30 rounded-2xl font-mono text-[10px] text-muted-foreground flex flex-col gap-3">
                <span className="text-[9px] uppercase tracking-wider text-muted-foreground border-b border-border/20 pb-2">📈 Monthly Stock Accuracy</span>
        ...
        >
          <motion.div variants={fadeInUp} className="w-full space-y-4">
            <span className="text-[#00229E] text-xs font-semibold tracking-widest uppercase block">Reflections</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight">
          ...
          >
            <p className="text-lg md:text-[20px] font-light text-foreground leading-relaxed border-l-4 border-[#00229E] pl-6 italic text-justify w-full font-inter font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 w-full pl-6">
                ...
                <div key={0} className="space-y-2 text-justify font-inter">
                  ...
                  <p className="text-sm text-justify font-inter">Translated complex SKU parameters into clear inventory routes.</p>
                </div>
                ...
                <div key={1} className="space-y-2 text-justify font-inter">
                  ...
                  <p className="text-sm text-justify font-inter">Positioned bulk shipment releases directly below warehouse alerts.</p>
                </div>
