...
export default function Web3WalletCaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-8 transition-colors duration-500 selection:bg-[#6366f1]/20">
      {/* Global Page Tint Accent */}
      <div className="fixed inset-0 z-[-1] pointer-events-none opacity-[0.15]" style={{ backgroundColor: "#6366f1" }} />
      ...
      <div className="relative overflow-hidden pt-32 pb-8 border-b border-border/10">
        ...
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-[#6366f1]/10 via-transparent to-transparent blur-[120px] pointer-events-none" />
        <div className="absolute -bottom-20 left-1/4 w-[400px] h-[400px] rounded-full bg-gradient-to-tr from-[#6366f1]/5 to-transparent blur-[100px] pointer-events-none" />
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-6xl">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black font-space-grotesk tracking-tight uppercase flex items-center h-10 sm:h-12 lg:h-14" style={{ color: "#6366f1" }}>
              Web3 Wallet
            </h1>
          ...
          <div className="mt-12 pt-8 border-t border-border/20 space-y-8">
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <span className="text-foreground/90 font-medium block pt-0.5 leading-relaxed">Mobile App & Web Bridge</span>
              </div>
              <div className="space-y-1.5">
                <span className="text-muted-foreground uppercase text-[10px] tracking-widest block font-bold">Tech Stack</span>
                <span className="text-foreground/90 font-medium block pt-0.5 leading-relaxed">React Native, Expo, Zustand, ethers.js, Web3</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl mt-16">
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-3">
            <span className="text-[#6366f1] text-xs font-semibold tracking-widest uppercase block">Operational Model / The Challenge</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight leading-tight">
              The Danger of Blind Web3 Transactions
            </h3>
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-3 w-full">
            <span className="text-[#6366f1] text-xs font-semibold tracking-widest uppercase block">Operational Model / Reality</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight md:whitespace-nowrap">
              Two Roles, One Unified Ledger
            </h3>
            ...
            <div className="bg-[#0B0B0C]/80 backdrop-blur-md border border-border/40 p-1.5 rounded-2xl sm:rounded-full flex flex-col sm:flex-row items-stretch sm:items-center justify-center max-w-md w-full shadow-2xl gap-1">
              <Button
                ...
                className={"flex-1 rounded-xl sm:rounded-full py-3.5 sm:py-5.5 cursor-pointer font-space-grotesk transition-all duration-300 " + (
                  selectedRole === "buyer" 
                    ? "bg-[#6366f1] text-black font-semibold shadow-[0_4px_15px_rgba(0,230,115,0.25)] hover:bg-[#6366f1]" 
                    : "text-muted-foreground hover:text-foreground hover:bg-foreground/5"
                )}
              >
                <Smartphone className="w-4 h-4 mr-2 flex-shrink-0" />
                <span className="truncate">DeFi Swapper</span>
              </Button>
              <Button
                ...
                className={"flex-1 rounded-xl sm:rounded-full py-3.5 sm:py-5.5 cursor-pointer font-space-grotesk transition-all duration-300 " + (
                  selectedRole === "seller" 
                    ? "bg-[#6366f1] text-black font-semibold shadow-[0_4px_15px_rgba(31,208,180,0.25)] hover:bg-[#6366f1]" 
                    : "text-muted-foreground hover:text-foreground hover:bg-foreground/5"
                )}
              >
                <Bot className="w-4 h-4 mr-2 flex-shrink-0" />
                <span className="truncate">Asset Auditor</span>
              </Button>
            </div>
          </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center font-inter">
                <div className="md:col-span-7 space-y-6">
                  <div className="flex items-center gap-3">
                    <span className="p-3.5 rounded-full bg-[#6366f1]/10 text-[#6366f1]">
                      <Zap className="w-6 h-6" />
                    </span>
                    <div>
                      <h4 className="text-xl font-bold font-space-grotesk tracking-wide text-foreground">
                        DeFi Swapper (Yield & Asset Optimization)
                      </h4>
                      <p className="text-xs text-[#6366f1] font-mono tracking-wider uppercase">Archetype: "High-Confidence"</p>
                    </div>
                  </div>
                  <p className="text-sm text-muted-foreground/90 leading-relaxed font-inter text-justify font-light">
                    The Swapper wants to exchange assets and monitor daily rewards. The design optimizes for fast transaction execution:
                  </p>
                  <ul className="space-y-3.5">
                      ...
                      <li key={2} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#6366f1] flex-shrink-0 mt-0.5" />
                        <span>Highlights dynamic yield metrics on the main screen.</span>
                      </li>
                ...
                <div className="md:col-span-5 p-4 bg-[#0B0B0C] border border-border/30 rounded-2xl flex flex-col gap-4 font-mono text-[11px] text-muted-foreground shadow-2xl relative overflow-hidden">
                  <div className="absolute top-2 right-2 px-2 py-0.5 rounded bg-[#6366f1]/10 border border-[#6366f1]/30 text-[#6366f1] text-[9px] uppercase tracking-widest font-mono">
                    Overview Screen
                  </div>
                    ...
                    <div className="text-[10px]">{"Filter: High APY • Polygon Grid • Wallet Balance: $4.2k"}</div>
                      ...
                      <div key={0} className="p-3 rounded-lg bg-card/60 border border-border/40 flex justify-between items-center">
                        ...
                        <div className="text-right font-mono">
                          <div className="font-bold text-[#6366f1] text-xs">Rate: $1.02 / unit</div>
                          <div>Action: Stake Assets</div>
                        </div>
                      </div>
                      ...
                      <div key={1} className="p-3 rounded-lg bg-card/60 border border-border/40 flex justify-between items-center">
                        <div>
                          <div className="font-bold text-foreground">⚡ MATIC Staking Node</div>
                          <div className="text-[10px]">Status: APY 6.2% • active</div>
                        </div>
                        <div className="text-right font-mono">
                          <div className="font-bold text-[#6366f1] text-xs">Rate: $0.85 / unit</div>
                          <div>Action: Stake Assets</div>
                        </div>
                      </div>
  
                  <div className="p-2.5 rounded-lg bg-[#6366f1]/10 border border-[#6366f1]/20 flex items-center justify-between text-foreground">
                    <span>Double Confirmation</span>
                    <span className="font-bold text-xs uppercase tracking-wider">{"Swipe to Stake Selected Assets [══►]"}</span>
                  </div>
                </div>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center font-inter">
                <div className="md:col-span-7 space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xl font-bold font-space-grotesk tracking-wide text-foreground">
                        Asset Auditor (Compliance & Gas Planning)
                      </h4>
                      <p className="text-xs text-[#6366f1] font-mono tracking-wider uppercase">Archetype: "Action-Oriented"</p>
                    </div>
                  </div>
                  <p className="text-sm text-muted-foreground/90 leading-relaxed font-inter text-justify font-light">
                    The Auditor (often a protocol developer or compliance officer) inspects pool transactions and gas history. The workspace provides deep auditing tools:
                  </p>
                  <ul className="space-y-3.5">
                    
                      <li key={0} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#6366f1] flex-shrink-0 mt-0.5" />
                        <span>Provides dynamic invoice builders to request customer payouts.</span>
                      </li>
  

                      <li key={1} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#6366f1] flex-shrink-0 mt-0.5" />
                        <span>Visualizes transaction margins through clean native SVG graphs.</span>
                      </li>
  

                      <li key={2} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#6366f1] flex-shrink-0 mt-0.5" />
                        <span>Enables fast refund sheets through sliding checkout drawers.</span>
                      </li>
                ...
                <div className="md:col-span-5 p-4 bg-[#0B0B0C] border border-border/30 rounded-2xl flex flex-col gap-4 font-mono text-[11px] text-muted-foreground shadow-2xl relative overflow-hidden">
                  ...
                  <div className="border-b border-border/30 pb-3">
                    <div className="font-bold text-foreground text-xs font-space-grotesk uppercase tracking-wider mb-1">{"📊 Gas Telemetry Dashboard"}</div>
                    <div className="text-[10px]">{"Session Status: RPC Synced"}</div>
                  </div>
                  
                      <div key={0} className="p-2.5 rounded-lg bg-card/60 border border-border/30 text-[10px]">
                        <span className="font-bold text-foreground block mb-0.5">Tx #4321 - Yield Swap</span>
                        State: Mined • Time: 12 sec • Gas: 42 Gwei • Passed
                      </div>
  

                      <div key={1} className="p-2.5 rounded-lg bg-card/60 border border-border/30 text-[10px]">
                        <span className="font-bold text-foreground block mb-0.5">Tx #4320 - Token Bridge</span>
                        State: Dropped • Time: 2 min • Gas: 12 Gwei • Timeout
                      </div>
  
                  <div className="flex gap-2">
                    <span className="px-2.5 py-1.5 rounded-full border border-border/30 bg-card text-[9px] cursor-pointer">{"Deploy Simulation to Mainnet (↑)"}</span>
                  </div>
                </div>
              </div>
            )}
        ...
        >
          <motion.div variants={fadeInUp} className="w-full space-y-4">
            <span className="text-[#6366f1] text-xs font-semibold tracking-widest uppercase block">Key Solution</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight">
              Core Design Moves
            </h3>
            <p className="text-[20px] text-muted-foreground/80 leading-relaxed text-justify font-inter">
          ...
          <motion.div variants={fadeInUp} className="p-8 rounded-[2rem] bg-card/30 border border-border/30 backdrop-blur-md space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/20 pb-6">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-full bg-[#6366f1]/10 text-[#6366f1] flex items-center justify-center font-bold font-space-grotesk text-lg border border-[#6366f1]/20">01</div>
                <div>
                  <h4 className="text-[22px] font-semibold font-space-grotesk tracking-wide text-foreground">
                    Sleek Portfolio Feed
                  </h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 leading-relaxed items-center">
              <div className="lg:col-span-7 space-y-5 font-inter text-[18px] text-muted-foreground/90">
                <p className="text-justify font-inter">
                  We consolidated raw hex logs and bridge states into a single, clean workspace with clear status indicators.
                </p>
              </div>
              ...
              <div className="lg:col-span-5 flex items-center justify-center w-full">
                  ...
                  <div className="h-28 border border-border/20 rounded-lg bg-card/30 p-2 flex items-end relative overflow-hidden">
                    <div dangerouslySetInnerHTML={{ __html: "<svg className=\"w-full h-[70%] stroke-[#6366f1] fill-none stroke-[2]\" viewBox=\"0 0 100 30\">\n                    <path d=\"M 0 25 Q 20 5, 40 20 T 80 5 T 100 15\" />\n                    <circle cx=\"40\" cy=\"20\" r=\"3\" className=\"fill-[#6366f1] stroke-white stroke-[1]\" />\n                  </svg>" }} className="w-full" />
                  </div>
          ...
          <motion.div variants={fadeInUp} className="p-8 rounded-[2rem] bg-card/30 border border-border/30 backdrop-blur-md space-y-8 font-inter">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/20 pb-6">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-full bg-[#6366f1]/10 text-[#6366f1] flex items-center justify-center font-bold font-space-grotesk text-lg border border-[#6366f1]/20">03</div>
                <div>
                  <h4 className="text-[22px] font-semibold font-space-grotesk tracking-wide text-foreground">
                    Conversational Gas Assistant AI
                  </h4>
                  <p className="text-xs text-muted-foreground font-mono">undefined</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 leading-relaxed items-center">
              <div className="lg:col-span-7 space-y-5 font-inter text-[18px] text-muted-foreground/90">
                <p className="text-justify font-inter">
                  Integrated an assistive chat helper inside the wallet app. Senders can ask 'Suggest lowest gas times' and receive instant historical feedback.
                </p>
              </div>
              ...
              <div className="lg:col-span-5 p-5 bg-[#0B0B0C] border border-border/30 rounded-2xl font-mono text-[10px] text-muted-foreground flex flex-col gap-3">
                <span className="text-[9px] uppercase tracking-wider text-muted-foreground border-b border-border/20 pb-2">📈 Protocol Volume Growth</span>
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-4">
            <span className="text-[#6366f1] text-xs font-semibold tracking-widest uppercase block">Impact</span>
          ...
          >
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  <div className="text-4xl font-black font-space-grotesk bg-gradient-to-r from-[#6366f1] to-foreground bg-clip-text text-transparent">
                    0.3s
                  </div>
                  <div>
                    <h4 className="text-base font-bold font-space-grotesk tracking-wide text-foreground mb-1">
                      Node Connection Sync
                    </h4>
                    <p className="text-xs text-muted-foreground leading-relaxed text-justify font-inter">
                      Optimized RPC socket routes enabled instant balance updates.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed text-justify font-inter">
                      Designed dynamic slippage alert widgets that react to gas spikes.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed text-justify font-inter">
                      Integrated local device security directly into the transaction slider.
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        >
          <motion.div variants={fadeInUp} className="w-full space-y-4">
            <span className="text-[#6366f1] text-xs font-semibold tracking-widest uppercase block">Reflections</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight">
          ...
          >
            <p className="text-lg md:text-[20px] font-light text-foreground leading-relaxed border-l-4 border-[#6366f1] pl-6 italic text-justify w-full font-inter font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 w-full pl-6">
                ...
                <div key={0} className="space-y-2 text-justify font-inter">
                  ...
                  <p className="text-sm text-justify font-inter">Translated technical smart contracts into clear transaction status tags.</p>
                </div>
                ...
                <div key={1} className="space-y-2 text-justify font-inter">
                  ...
                  <p className="text-sm text-justify font-inter">Positioned stake triggers directly next to active wallet balances.</p>
                </div>
