...
export default function NetworkCmsCaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-8 transition-colors duration-500 selection:bg-[#ea580c]/20">
      {/* Global Page Tint Accent */}
      <div className="fixed inset-0 z-[-1] pointer-events-none opacity-[0.15]" style={{ backgroundColor: "#ea580c" }} />
      ...
      <div className="relative overflow-hidden pt-32 pb-8 border-b border-border/10">
        ...
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-[#ea580c]/10 via-transparent to-transparent blur-[120px] pointer-events-none" />
        <div className="absolute -bottom-20 left-1/4 w-[400px] h-[400px] rounded-full bg-gradient-to-tr from-[#ea580c]/5 to-transparent blur-[100px] pointer-events-none" />
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-6xl">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black font-space-grotesk tracking-tight uppercase flex items-center h-10 sm:h-12 lg:h-14" style={{ color: "#ea580c" }}>
              Network CMS
            </h1>
          ...
          <div className="mt-12 pt-8 border-t border-border/20 space-y-8">
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <span className="text-foreground/90 font-medium block pt-0.5 leading-relaxed">Web Editor & Mobile Reviewer</span>
              </div>
              <div className="space-y-1.5">
                <span className="text-muted-foreground uppercase text-[10px] tracking-widest block font-bold">Tech Stack</span>
                <span className="text-foreground/90 font-medium block pt-0.5 leading-relaxed">React, tailwind CSS, GraphQL, Node.js, Slate.js</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl mt-16">
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-4">
            <span className="text-[#ea580c] text-xs font-semibold tracking-widest uppercase block">Impact</span>
          ...
          >
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  <div className="text-4xl font-black font-space-grotesk bg-gradient-to-r from-[#ea580c] to-foreground bg-clip-text text-transparent">
                    50%
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed text-justify font-inter">
                      Consolidated editing tools into a single live markdown canvas workspace.
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-3">
            <span className="text-[#ea580c] text-xs font-semibold tracking-widest uppercase block">Operational Model / The Challenge</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight leading-tight">
              The Friction of Cluttered Editing Systems
            </h3>
            ...
            <div className="space-y-6 text-base md:text-[20px] leading-relaxed text-muted-foreground/80 font-inter">
                ...
                <div key={0} className="space-y-1 pt-4 first:pt-0 border-t first:border-t-0 border-border/10">
                  <h4 className="font-bold text-foreground font-space-grotesk uppercase tracking-wider text-xs flex items-center gap-2">
                    ...
                    01 / Isolated File Folders
                  </h4>
                  <p className="text-sm pl-3.5 text-justify font-inter">Written drafts and layout assets lived in disjointed folders, requiring manual uploads.</p>
                </div>
                ...
                <div key={2} className="space-y-1 pt-4 first:pt-0 border-t first:border-t-0 border-border/10">
                  <h4 className="font-bold text-foreground font-space-grotesk uppercase tracking-wider text-xs flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-500/80 animate-pulse" />
                    03 / Disconnected Revision Tools
                  </h4>
                  <p className="text-sm pl-3.5 text-justify font-inter">Comparing dynamic draft histories required editors to swap between terminal and editor.</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center font-inter">
                <div className="md:col-span-7 space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xl font-bold font-space-grotesk tracking-wide text-foreground">
                        Creative Writer (Focused Markdown Drafting)
                      </h4>
                      <p className="text-xs text-[#ea580c] font-mono tracking-wider uppercase">Archetype: "High-Confidence"</p>
                    </div>
                  </div>
                  ...
                  <ul className="space-y-3.5">
                      ...
                      <li key={0} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        ...
                        <span>Replaces dry settings panels with a sleek, cardless live editor canvas.</span>
                      </li>
                ...
                <div className="md:col-span-5 p-4 bg-[#0B0B0C] border border-border/30 rounded-2xl flex flex-col gap-4 font-mono text-[11px] text-muted-foreground shadow-2xl relative overflow-hidden">
                  ...
                  <div className="border-b border-border/30 pb-3">
                    <div className="font-bold text-foreground text-xs font-space-grotesk uppercase tracking-wider mb-1">{"📝 Slate Markdown Editor"}</div>
                    <div className="text-[10px]">{"Filter: Active Drafts • Delhi Team • Target: 1,200 words"}</div>
                  </div>
                  
                      <div key={0} className="p-3 rounded-lg bg-card/60 border border-border/40 flex justify-between items-center">
                        <div>
                          <div className="font-bold text-foreground">📄 Article: Green Energy P2P</div>
                          <div className="text-[10px]">Status: Drafting • 820 words • Noida</div>
                        </div>
                        <div className="text-right font-mono">
                          <div className="font-bold text-[#ea580c] text-xs">Category: Clean Tech</div>
                          <div>Action: Complete Draft</div>
                        </div>
                      </div>
                      ...
                      <div key={1} className="p-3 rounded-lg bg-card/60 border border-border/40 flex justify-between items-center">
                        <div>
                          <div className="font-bold text-foreground">📄 Article: DePIN Validators</div>
                          <div className="text-[10px]">Status: Finished • 1,400 words • Delhi</div>
                        </div>
                        <div className="text-right font-mono">
                          <div className="font-bold text-[#ea580c] text-xs">Category: Web3 Finance</div>
                          <div>Action: Submit to Editor</div>
                        </div>
                      </div>
  
                  <div className="p-2.5 rounded-lg bg-[#ea580c]/10 border border-[#ea580c]/20 flex items-center justify-between text-foreground">
                    <span>Double Confirmation</span>
                    <span className="font-bold text-xs uppercase tracking-wider">{"Submit Article for Brand Review"}</span>
                  </div>
                </div>
              </div>
            ) : (
        ...
        >
          <motion.div variants={fadeInUp} className="w-full space-y-4">
            <span className="text-[#ea580c] text-xs font-semibold tracking-widest uppercase block">Key Solution</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight">
              Core Design Moves
            </h3>
            <p className="text-[20px] text-muted-foreground/80 leading-relaxed text-justify font-inter">
          ...
          <motion.div variants={fadeInUp} className="p-8 rounded-[2rem] bg-card/30 border border-border/30 backdrop-blur-md space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/20 pb-6">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-full bg-[#ea580c]/10 text-[#ea580c] flex items-center justify-center font-bold font-space-grotesk text-lg border border-[#ea580c]/20">01</div>
                <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 leading-relaxed items-center">
              <div className="lg:col-span-7 space-y-5 font-inter text-[18px] text-muted-foreground/90">
                <p className="text-justify font-inter">
                  We consolidated multiple editor settings and media databases into a single, clean workspace with clear status indicators.
                </p>
              </div>
              ...
              <div className="lg:col-span-5 flex items-center justify-center w-full">
                  ...
                  <div className="h-28 border border-border/20 rounded-lg bg-card/30 p-2 flex items-end relative overflow-hidden">
                    <div dangerouslySetInnerHTML={{ __html: "<svg className=\"w-full h-[70%] stroke-[#ea580c] fill-none stroke-[2]\" viewBox=\"0 0 100 30\">\n                    <path d=\"M 0 25 Q 20 5, 40 20 T 80 5 T 100 15\" />\n                    <circle cx=\"40\" cy=\"20\" r=\"3\" className=\"fill-[#ea580c] stroke-white stroke-[1]\" />\n                  </svg>" }} className="w-full" />
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 leading-relaxed items-center font-inter">
              ...
              <div className="lg:col-span-5 flex items-center justify-center order-2 lg:order-1">
                <div className="relative rounded-3xl overflow-hidden border border-border/40 shadow-2xl bg-card max-w-[220px]">
                  <img 
                    src="undefined" 
                    alt="Interactive Editor Sliders" 
              ...
              <div className="lg:col-span-7 space-y-5 font-inter text-base md:text-[18px] text-muted-foreground/90 order-1 lg:order-2">
                <p className="text-justify font-inter">
                  Designed interactive sliders that let editors scale viewport previews instantly, avoiding sluggish browser reloads.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="p-8 rounded-[2rem] bg-card/30 border border-border/30 backdrop-blur-md space-y-8 font-inter">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/20 pb-6">
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-full bg-[#ea580c]/10 text-[#ea580c] flex items-center justify-center font-bold font-space-grotesk text-lg border border-[#ea580c]/20">03</div>
                <div>
                  <h4 className="text-[22px] font-semibold font-space-grotesk tracking-wide text-foreground">
                    Conversational Drafting AI
                  </h4>
                  <p className="text-xs text-muted-foreground font-mono">undefined</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 leading-relaxed items-center">
              <div className="lg:col-span-7 space-y-5 font-inter text-[18px] text-muted-foreground/90">
                <p className="text-justify font-inter">
                  Integrated an assistive chat module inside the writer app. Writers can ask 'Suggest synonyms for transaction' and receive instant vocabulary feedback.
                </p>
              </div>
              ...
              <div className="lg:col-span-5 p-5 bg-[#0B0B0C] border border-border/30 rounded-2xl font-mono text-[10px] text-muted-foreground flex flex-col gap-3">
                <span className="text-[9px] uppercase tracking-wider text-muted-foreground border-b border-border/20 pb-2">📈 Annual Article Production</span>
        ...
        >
          <motion.div variants={fadeInUp} className="w-full space-y-4">
            <span className="text-[#ea580c] text-xs font-semibold tracking-widest uppercase block">Reflections</span>
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight">
          ...
          >
            <p className="text-lg md:text-[20px] font-light text-foreground leading-relaxed border-l-4 border-[#ea580c] pl-6 italic text-justify w-full font-inter font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 w-full pl-6">
                ...
                <div key={0} className="space-y-2 text-justify font-inter">
                  ...
                  <p className="text-sm text-justify font-inter">Translated complex editorial policies into clear layout status levels.</p>
                </div>
                ...
                <div key={1} className="space-y-2 text-justify font-inter">
                  ...
                  <p className="text-sm text-justify font-inter">Positioned publish buttons directly next to active editor canvases.</p>
                </div>
