        ...
        >
          <motion.div variants={fadeInUp} className="space-y-3 w-full">
            ...
            <h3 className="text-[22px] font-semibold font-space-grotesk tracking-tight md:whitespace-nowrap">
              Two Roles, One Connected Floor
            </h3>
            <p className="text-lg md:text-[20px] text-muted-foreground w-full text-justify font-inter">
              We designed Iris Sense to serve central dispatchers coordinating multiple multi-story warehouses, and mobile inspectors executing field audits on the floor.
            </p>
          </motion.div>
            ...
            <div className="bg-[#0B0B0C]/80 backdrop-blur-md border border-border/40 p-1.5 rounded-2xl sm:rounded-full flex flex-col sm:flex-row items-stretch sm:items-center justify-center max-w-md w-full shadow-2xl gap-1">
              <Button
                ...
                className={"flex-1 rounded-xl sm:rounded-full py-3.5 sm:py-5.5 cursor-pointer font-space-grotesk transition-all duration-300 " + (
                  selectedRole === "buyer" 
                    ? "bg-[#F7CF58] text-black font-semibold shadow-[0_4px_15px_rgba(0,230,115,0.25)] hover:bg-[#F7CF58]" 
              ...
              <Button
                ...
                className={"flex-1 rounded-xl sm:rounded-full py-3.5 sm:py-5.5 cursor-pointer font-space-grotesk transition-all duration-300 " + (
                  selectedRole === "seller" 
                    ? "bg-[#F7CF58] text-black font-semibold shadow-[0_4px_15px_rgba(31,208,180,0.25)] hover:bg-[#F7CF58]" 
                    : "text-muted-foreground hover:text-foreground hover:bg-foreground/5"
                )}
              >
                <Bot className="w-4 h-4 mr-2 flex-shrink-0" />
                <span className="truncate">Field Inspector</span>
              </Button>
            </div>
          </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center font-inter">
                <div className="md:col-span-7 space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xl font-bold font-space-grotesk tracking-wide text-foreground">
                                                Field Inspector (Sensor Calibration Focus)
                      </h4>
                      <p className="text-xs text-[#F7CF58] font-mono tracking-wider uppercase">Archetype: "Action-Oriented"</p>
                    </div>
                  </div>
                  <p className="text-sm text-muted-foreground/90 leading-relaxed font-inter text-justify font-light">
                    The Inspector traverses the warehouse checking physical hardware. The tablet experience provides offline diagnostic tools and quick checklist runs:
                  </p>
                  <ul className="space-y-3.5">
                    
                      <li key={0} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#F7CF58] flex-shrink-0 mt-0.5" />
                        <span>Provides structured checklist templates detailing calibration tasks.</span>
                      </li>
  

                      <li key={1} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#F7CF58] flex-shrink-0 mt-0.5" />
                        <span>Uses Bluetooth local scanning to fetch ambient sensor data instantly.</span>
                      </li>
  

                      <li key={2} className="flex gap-3 text-sm text-muted-foreground text-justify font-inter">
                        <CheckCircle2 className="w-4 h-4 text-[#F7CF58] flex-shrink-0 mt-0.5" />
                        <span>Enables offline logging to queue compliance reports inside insulated steel rooms.</span>
                      </li>
                ...
                <div className="md:col-span-5 p-4 bg-[#0B0B0C] border border-border/30 rounded-2xl flex flex-col gap-4 font-mono text-[11px] text-muted-foreground shadow-2xl relative overflow-hidden">
                  ...
                  <div className="border-b border-border/30 pb-3">
                    <div className="font-bold text-foreground text-xs font-space-grotesk uppercase tracking-wider mb-1">{"📋 Field Ambient Inspector App"}</div>
                    <div className="text-[10px]">{"Session Status: Offline Cache Active"}</div>
                  </div>
                  
                      <div key={0} className="p-2.5 rounded-lg bg-card/60 border border-border/30 text-[10px]">
                        <span className="font-bold text-foreground block mb-0.5">Sensor #104 - Temp Gauge</span>
                        Type: Thermocouple • Room 102 • Action: Ref Lead Calib
                      </div>
  

                      <div key={1} className="p-2.5 rounded-lg bg-card/60 border border-border/30 text-[10px]">
                        <span className="font-bold text-foreground block mb-0.5">Sensor #103 - Press Gauge</span>
                        Type: Piezoelectric • Room 104 • Action: Seal Integrity Test
                      </div>
  
                  <div className="flex gap-2">
                    <span className="px-2.5 py-1.5 rounded-full border border-border/30 bg-card text-[9px] cursor-pointer">{"Commit Calibration Checklist (↑)"}</span>
                  </div>
                </div>
              </div>
            )}
