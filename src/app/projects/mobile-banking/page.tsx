      ...
      <main className="max-w-[1400px] w-full mx-auto px-6 sm:px-8 lg:px-12 pt-[48px] space-y-[24px]">
        ...
        >
          <div className="space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold font-space-grotesk tracking-tight uppercase">Mobile Banking</h1>
            <h2 className="text-xl md:text-2xl text-muted-foreground font-light leading-relaxed">
              Premium biometric mobile banking application simplifying daily deposits, transfers, and asset tracking.
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-y border-border/30">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium">Mobile iOS & Android</p>
            </div>
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Badge variant="secondary">LocalAuthentication</Badge>
              </div>
            </div>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-2">
              <div className="text-4xl font-black font-space-grotesk" style={{ color: "#059669" }}>0.5s</div>
              <h4 className="font-bold text-foreground">Biometric Auth Sync</h4>
              <p className="text-sm text-muted-foreground">Optimized FaceID handshakes enabled instant safe app logins.</p>
            </div>
            <div className="space-y-2">
              <div className="text-4xl font-black font-space-grotesk" style={{ color: "#059669" }}>40%</div>
              <h4 className="font-bold text-foreground">Fewer Transfer Drops</h4>
            ...
            <div className="space-y-2">
              <div className="text-4xl font-black font-space-grotesk" style={{ color: "#059669" }}>100%</div>
              <h4 className="font-bold text-foreground">Account Balance Sync</h4>
              <p className="text-sm text-muted-foreground">GraphQL subscriptions updated financial statements with zero data delay.</p>
            </div>
          </div>
        </motion.section>
        ...
        >
          ...
          <Tabs defaultValue="role1" className="w-full mt-8">
            <TabsList className="grid w-full grid-cols-2 h-auto p-1 bg-muted/50">
              <TabsTrigger value="role1" className="py-3 text-sm font-bold data-[state=active]:bg-[#059669] data-[state=active]:text-black transition-all">
                Retail Customer
              </TabsTrigger>
              <TabsTrigger value="role2" className="py-3 text-sm font-bold data-[state=active]:bg-[#059669] data-[state=active]:text-black transition-all">
                Wealth Manager
              </TabsTrigger>
            </TabsList>
            <TabsContent value="role1" className="mt-6">
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">The Customer wants to transfer cash instantly with zero friction. The design optimizes for fast transaction execution:</p>
            ...
            <TabsContent value="role2" className="mt-6">
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">The Manager coordinates incoming payments and tracks invoice compliance. The interface optimizes for clear status auditing:</p>
                  <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
        ...
        >
          ...
          <div className="space-y-6 mt-8">
            ...
            <Card className="border-l-4 bg-card/40" style={{ borderLeftColor: "#059669" }}>
              <CardContent className="p-6 grid gap-4">
                <div>
                  <h4 className="text-sm font-bold text-muted-foreground uppercase">Problem Tackled</h4>
                  <p className="font-medium mt-1 leading-relaxed">Eliminating ledger clutter</p>
                </div>
                <div className="mt-2 pt-4 border-t border-border/20">
                  <h4 className="text-sm font-bold text-muted-foreground uppercase flex items-center gap-2"><ShieldCheck className="w-4 h-4"/> Sleek Spending Feed</h4>
            ...
            <Card className="border-l-4 border-l-purple-500 bg-card/40 mt-6">
              <CardContent className="p-6 grid gap-4">
                <div>
                  <h4 className="text-sm font-bold text-muted-foreground uppercase">Problem Tackled</h4>
                  <p className="font-medium mt-1 leading-relaxed">Assisting wealth diagnostics</p>
                </div>
                <div className="mt-2 pt-4 border-t border-border/20">
