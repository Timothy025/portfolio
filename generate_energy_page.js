...
export default function AatralCaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24 font-inter">
      ...
      <main className="max-w-4xl mx-auto px-[48px] pt-[48px] space-y-[24px]">
        {/* HEADER & OVERVIEW */}
        <motion.section 
          initial="hidden" 
          whileInView="visible" 
...
fs.writeFileSync(path.join(__dirname, 'src/app/projects/energy.tsx'), content);
console.log('Successfully generated clean page: ' + path.join(__dirname, 'src/app/projects/energy.tsx'));
